                ...
                <?php foreach ($posts as $post): ?>
                  <tr role="row">
                    ...
                    <td class="text-right">
                      ...
                      <a href="<?= $this->Url->build('/', true) ?><?= strtolower($this->request->getParam('controller')) ?>/edit/<?= $post->id; ?>" class="btn btn-round btn-warning btn-icon btn-sm" rel="tooltip" title="Editar" data-placement="left"><i class="fas fa-edit"></i></a>
                      <a onclick="system.showSwal('Eliminar','¿Eliminar la publicación '+'<?= $post->title ?>'+' ?','delete', '<?= $this->Url->build('/', true) ?><?= strtolower($this->request->getParam('controller')) ?>/delete/<?= $post->id; ?>')" class="btn btn-round btn-danger btn-icon btn-sm text-white" rel="tooltip" title="Eliminar" data-placement="left"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach ?>
              </tbody>
