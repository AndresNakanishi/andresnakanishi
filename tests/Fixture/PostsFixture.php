...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image_url' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'fk_author_post' => ['type' => 'foreign', 'columns' => ['author_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'fk_cat_post' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created_at' => '2020-01-12 00:22:42',
                'updated_at' => '2020-01-12 00:22:42',
                'published_at' => '2020-01-12 00:22:42',
            ],
        ];
        parent::init();
    }
