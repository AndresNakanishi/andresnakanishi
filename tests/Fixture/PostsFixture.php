...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'img_url' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created_at' => '2020-01-12 04:47:52',
                'updated_at' => '2020-01-12 04:47:52',
                'published_at' => '2020-01-12 04:47:52',
            ],
        ];
        parent::init();
    }
